...
public:
    ...
    Sophus::SE3f GrabImageRGBD(const cv::Mat &mask, const cv::Mat &imRGB,const cv::Mat &imD, const double &timestamp, string filename);
...
protected:
    ...
    cv::Mat reprojectMask();
    void reprojectStaticPoints();
